<main class="content">
    ...
    <div>
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                <?php foreach($report as $registry): //$report = data que passamos como parametro para essa view, e pegar cada um dos registros dentro do relatório para preencher as informações ?>
                    <tr>
